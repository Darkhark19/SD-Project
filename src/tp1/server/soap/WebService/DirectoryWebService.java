...
public class DirectoryWebService implements SoapDirectory {
    ...
    private final Directory directory = new JavaDirectory();
    ...
    @Override
    public void deleteClientFiles(String userId) throws DirectoryException {
        var response = directory.deleteClientFiles(userId);
        result(response);
    }
}
